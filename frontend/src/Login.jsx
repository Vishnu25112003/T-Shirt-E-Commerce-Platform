...
const Login = () => {
      ...
      <div className="w-full max-w-md transform transition-all duration-300 hover:scale-[1.01]">
        <div className="bg-white rounded-2xl p-8 shadow-2xl space-y-6 animate-fade-in-up">
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-bold text-slate-900 animate-slide-in-top">Welcome Bro!</h1>
            <p className="text-slate-600 text-sm font-medium">Login Here</p>
          </div>
  ...
  <Link to="/signin" className="text-blue-600 hover:underline font-medium">Signin</Link>  {/* Use Link instead of <a> */}
</p>
        </div>

        <div className="mt-6 text-center">
          <p className="text-sm text-slate-400 animate-pulse">Copyrights, 2025 all rights reserved.</p>
        </div>
      </div>
    </div>
  );
